...
# Боковая панель: API-ключ и управление
with st.sidebar:
    ...
    st.divider()
    st.caption("Поиск по всем загруженным документам. Для точного результата указывайте номер статьи и название закона.")
...
# Системный промпт с глоссарием и требованием источников
...
if prompt := st.chat_input("Задайте вопрос по страховому законодательству РК..."):
    ...
    with st.chat_message("assistant"):
        with st.spinner("🔍 Анализирую законы..."):
            try:
                # Поиск релевантных документов (увеличено до 8 фрагментов)
